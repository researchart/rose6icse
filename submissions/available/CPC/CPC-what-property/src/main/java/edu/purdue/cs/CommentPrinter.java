 ...
 */
class CommentPrinter extends AllFalseVisitor {
    ...
    private Map<String, List<Comment>> paramList = new HashMap<>();
    private int paramRank;

    public CommentPrinter(String src, String pck, CodeLists lists) {
        super();
        source = src;
        pack = pck;
        codeLists = lists;
...
//        codeLists.fields.add(field);
    ...
    public boolean visit(SingleVariableDeclaration node) {
        ...
        if (binding.isParameter()) {
            ...
            List<Comment> paramComments = paramList.get(paramName);
    ...
    private ArrayList<Comment> JavadocToCmt(Javadoc doc, String codeEntityId,
        ...
        for (Object o : doc.tags()) {
            ...
            if ("@param".equals(tag.getTagName())) {
                ...
                paramList.put(paramName, comments);
...
//                        str += "is" + " ";
    ...
    private ArrayList<Comment> StrToCmt(String str, String tag,
        ...
        String cleaned = DataCleaner.clean(str).toLowerCase();
