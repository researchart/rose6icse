...
public class XMLEditor {
	...
	public static void addStanfordTree(XSSFSheet sheet) {
		for (int i = 1; i <= sheet.getLastRowNum(); i++) {
			...
			XMLUtil.setNumericCell(sheet, i, 16, (int)count.get("NP"));
			XMLUtil.setNumericCell(sheet, i, 17, (int)count.get("VP"));
			XMLUtil.setNumericCell(sheet, i, 18, (int)count.get("PP"));
			...
			XMLUtil.setNumericCell(sheet, i, 20, (int)count.get("auxpass"));
			XMLUtil.setNumericCell(sheet, i, 21, (int)count.get("case"));
			XMLUtil.setNumericCell(sheet, i, 22, (int)count.get("tmod"));
			XMLUtil.setNumericCell(sheet, i, 23, (int)count.get("advmod"));
			XMLUtil.setNumericCell(sheet, i, 24, (int)count.get("preconj"));
		}
