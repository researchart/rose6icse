...
function varargout=sldemo_tankgui(action)
%SLDEMO_TANKGUI GUI for sldemo_tank model
%
%   SLDEMO_TANKGUI manages the animation UI for the Simulink tank example.
%   
...
ui.edit.Callback = 'sldemo_tankgui update';
...
tagStrings       = LocalGetFigureTagStrings;
closeRequestFcns = {'sldemo_tankgui done',   'sldemo_tankgui close'};
