...
typedef struct Node {
    ...
    Interval observableWin; /* future observable lower/upper bounds */
    int antecedent;/* is 1 if the node is antecedent, 0 otherwise*/
    int conjunction;/* is 1 if the node is a conjunct, 0 otherwise*/  
	struct Symbol *sym;
