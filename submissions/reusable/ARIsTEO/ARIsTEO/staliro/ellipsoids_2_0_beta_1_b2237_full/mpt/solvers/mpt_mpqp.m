                            ...
                            if (nMatch>=1)
                                ...
                                elseif(mpt_iscombequal(find(lambda>0),ii))
                                    ...
                                    if(noNewFacetFound)
                                        ...
                                        [Pcr,Fi{nR},Gi{nR},kr]=sub1_computelaw(ii,nu,nx,Matrices,Options);
                                        for reg_ctr=1:length(Fii)
                                            Fi{nR}=Fii{reg_ctr};
                                            Gi{nR}=Gii{reg_ctr};
                                            Pn(nR)=Pcr(reg_ctr);
...
% SUBFUNCTION 1
%------------------------------------------------------------------------------------------
function [Pcr,Fcontrol,Gcontrol,Krows] = sub1_computelaw(ii,nu,nx,Matrices,Options)
%----------------------------------------------------------------
