...
if nargin & ischar(p)
   ...
   set(f,'CloseRequestFcn','set(gcbo,''UserData'',-abs(get(gcbo,''UserData'')));','UserData',[cputime cputime 0]);
   drawnow;
...
text(16,20,'Remaining (estimated):',a);
%%text(200,36,'hours',a);
%%text(200,20,'hours',a);
%
%Information texts
...
text(238,36,'0:00:00',a,'Tag','Time');
text(238,20,'0:00:00',a,'Tag','Task');
