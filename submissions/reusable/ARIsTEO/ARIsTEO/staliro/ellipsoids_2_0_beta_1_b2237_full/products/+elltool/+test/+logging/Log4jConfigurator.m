...
%             System Analysis Department 2011 $
    ...
    properties(Constant)
        SP_MAIN_LOG_FILE_NAME='elltool.testrunner.log4j.logfile.main.name'
        SP_CUR_PROCESS_NAME='elltool.testrunner.log4j.curProcessName'
        SP_LOG_DIR_WITH_SEP='elltool.testrunner.log4j.logfile.dirwithsep'
        SP_LOG_FILE_EXP='elltool.testrunner.log4j.logfile.ext'
        CONF_REPO_MGR_CLASS=...
    ...
    methods (Static)
        function configure(confSource,varargin)
            ...
            %
            self=elltool.test.logging.Log4jConfigurator();
