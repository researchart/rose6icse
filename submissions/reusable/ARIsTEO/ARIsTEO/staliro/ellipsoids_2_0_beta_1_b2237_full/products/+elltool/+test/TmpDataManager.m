...
% TMPDATAMANAGER - provides a basic functionality for 
%                  managing temporary data folders,
%                  root folder name is determined 
%                  automatically
%
    methods (Static)
        function setRootDir()
            curFilePath=which('elltool.test.run_tests');
            %
        ...
        %               specified key and makes sure that this directory is
        %               empty
        %
        % Input:
        %   regular:
        ...
        function resDir=getDirByCallerKey(keyName)
            ...
            %                     based on caller name and optionally based
            %                     on a specified key and makes sure that
