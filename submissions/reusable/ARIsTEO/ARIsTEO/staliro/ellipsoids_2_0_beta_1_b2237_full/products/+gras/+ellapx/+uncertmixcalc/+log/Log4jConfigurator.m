...
classdef Log4jConfigurator<modgen.logging.log4j.Log4jConfigurator
    ...
    properties(Constant)
        SP_MAIN_LOG_FILE_NAME='gras.ellapx.uncertmixcalc.log4j.logfile.main.name'
        SP_CUR_PROCESS_NAME='gras.ellapx.uncertmixcalc.log4j.curProcessName'
        SP_LOG_DIR_WITH_SEP='gras.ellapx.uncertmixcalc.log4j.logfile.dirwithsep'
        SP_LOG_FILE_EXP='gras.ellapx.uncertmixcalc.log4j.logfile.ext'
        CONF_REPO_MGR_CLASS='gras.ellapx.uncertmixcalc.conf.IConfRepoMgr';
    end
    ...
    methods (Static)
        function configure(confSource,varargin)
            ...
            %
            self=gras.ellapx.uncertmixcalc.log.Log4jConfigurator();
        ...
        function logFileName=getMainLogFileName()
            self=gras.ellap.uncertmixcalc.log.Log4jConfigurator();
