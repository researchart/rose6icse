...
people_csv = './people_12_months.csv'
...
def collect_emails():
    with open(cloned_repos_csv, 'r') as f: 
        ...
        for p in repos_list:
            ...
            counter += 1
            contributors = subprocess.check_output('cd ' + p['absolute_clone_path'] + ';git log --since="12 month ago" --pretty="%ae" | sort | uniq;', shell=True, universal_newlines=True)
